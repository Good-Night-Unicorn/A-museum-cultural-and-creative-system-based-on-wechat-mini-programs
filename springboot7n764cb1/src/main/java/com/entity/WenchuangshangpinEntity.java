...
public class WenchuangshangpinEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public WenchuangshangpinEntity() {
		
	}
	
	public WenchuangshangpinEntity(T t) {
		try {
	 ...
	 * 设置：民族文化
	 */
	public void setMinzuwenhua(String minzuwenhua) {
		this.minzuwenhua = minzuwenhua;
	}
	/**
	 * 获取：民族文化
	 */
	public String getMinzuwenhua() {
		return minzuwenhua;
	}
	/**
	 * 设置：产品介绍
	 ...
	 * 设置：传统故事
	 */
	public void setChuantonggushi(String chuantonggushi) {
		this.chuantonggushi = chuantonggushi;
	}
	/**
	 * 获取：传统故事
	 */
	public String getChuantonggushi() {
		return chuantonggushi;
	}
	/**
	 * 设置：赞
	 */
