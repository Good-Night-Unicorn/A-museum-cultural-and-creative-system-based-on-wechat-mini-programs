<template>
	<div class="addEdit-block">
		...
		>
			<template >
				<el-form-item class="input" v-if="type!='info'"  label="排行榜名称" prop="paixingbangmingcheng" >
					<el-input v-model="ruleForm.paixingbangmingcheng" placeholder="排行榜名称" clearable  :readonly="ro.paixingbangmingcheng"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="排行榜名称" prop="paixingbangmingcheng" >
					<el-input v-model="ruleForm.paixingbangmingcheng" placeholder="排行榜名称" readonly></el-input>
				</el-form-item>
				...
				<el-form-item class="input" v-if="type!='info'"  label="排名" prop="paiming" >
					<el-input v-model="ruleForm.paiming" placeholder="排名" clearable  :readonly="ro.paiming"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="排名" prop="paiming" >
				...
				<el-form-item class="input" v-if="type!='info'"  label="积分" prop="jifen" >
					<el-input-number v-model="ruleForm.jifen" placeholder="积分" :disabled="ro.jifen"></el-input-number>
				</el-form-item>
				...
				<el-form-item class="select" v-if="type!='info'"  label="用户账号" prop="yonghuzhanghao" >
					<el-select :disabled="ro.yonghuzhanghao" v-model="ruleForm.yonghuzhanghao" placeholder="请选择用户账号" >
						<el-option
			...
			async onSubmit() {
					...
					await this.$refs["ruleForm"].validate(async valid => {
						if (valid) {
							...
							await this.$http({
								url: `jifenpaixingbang/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(async ({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.jifenpaixingbangCrossAddOrUpdateFlag = false;
											this.parent.search();
