			...
			<view :style='{"minHeight":"100vh","width":"100%","padding":"20rpx 20rpx 240rpx","position":"relative","background":"#DCF7FF","height":"auto"}'>
				<view class="cu-bar bg-white search" :style='{"width":"100%","padding":"20rpx 0 0","background":"none","display":"flex","height":"auto"}'>
					<view :style='{"margin":"0 12rpx 0 0","flex":"1","position":"relative"}' class="search-form round">
						...
						<input placeholder-style="color: #333" :style='{"border":"2rpx solid rgb(55, 232, 220)","padding":"12rpx 20rpx 12rpx 80rpx","color":"#333","borderRadius":"10rpx","background":"#fff","width":"100%","lineHeight":"56rpx","fontSize":"28rpx","height":"80rpx"}' v-model="searchForm.title" type="text" placeholder="标题" ></input>
					</view>
				...
				<view :style='{"width":"100%","background":"none","height":"auto"}'>
					...
					<!-- 样式6 -->
					<view class="news-box6" :style='{"width":"100%","padding":"24rpx 0 0","height":"auto"}'>
						<view @tap="onDetailTap(product)" v-for="(product,index) in list" :key="index" class="list-item" :style='{"width":"100%","padding":"0","margin":"0 0 20rpx","borderRadius":"20rpx","background":"#fff","display":"flex"}'>
							<view :style='{"borderColor":"#37E8DC","alignItems":"center","color":"#37E8DC","flexDirection":"column","display":"flex","justifyContent":"center","borderRadius":"20rpx 50% 50% 20rpx","background":"none","borderWidth":"4rpx","width":"200rpx","fontSize":"40rpx","borderStyle":"solid","fontWeight":"bold"}' class="num">
								<view style="width: 100%;height: 100%;position: absolute;left: 0;top: 0;" :style="{transform: 'rotate('+(-index*60)+'deg)'}" class="dian">
									<view :style='{"transform":"translateX(-50%)","borderRadius":"100%","top":"-8rpx","left":"50%","background":"#37E8DC","display":"none","width":"16rpx","position":"absolute","height":"16rpx"}' />
								</view>{{ index + 1 < 10 ? '0'+(index+1) : index+1 }}
							</view>
							<view class="item-list-body" :style='{"padding":"0 20rpx","flexWrap":"wrap","flex":"1","display":"flex"}'>
								<view :style='{"padding":"0","margin":"0","whiteSpace":"nowrap","overflow":"hidden","color":"#000","width":"100%","lineHeight":"60rpx","fontSize":"30rpx","textOverflow":"ellipsis","order":"1"}' class="title ">{{product.title}}</view>
								<view :style='{"padding":"0","whiteSpace":"nowrap","overflow":"hidden","color":"#AEAEAE","width":"100%","lineHeight":"60rpx","fontSize":"28rpx","textOverflow":"ellipsis","order":"2"}' class="text ">{{product.introduction}}</view>
								<view :style='{"padding":"0 20rpx 0 0","order":"7"}'>
									<text class="icon iconfont icon-shijian21" :style='{"margin":"0 4rpx 0 0","lineHeight":"50rpx","fontSize":"24rpx","color":"#58C8B1"}'></text>
									<text :style='{"color":"#58C8B1","lineHeight":"50rpx","fontSize":"24rpx"}'>{{product.addtime.split(' ')[0].replace(/\-/g,'-')}}</text>
								</view>
								<view :style='{"width":"40%","padding":"0 20rpx 0 0","order":"6"}'>
									...
									<text :style='{"color":"#6DB1DD","lineHeight":"50rpx","fontSize":"24rpx"}'>{{product.name}}</text>
								</view>
								<view :style='{"width":"20%","padding":"0 20rpx 0 0","display":"inline-block","order":"3"}'>
									...
									<text :style='{"color":"#19BFF0","lineHeight":"50rpx","fontSize":"24rpx"}'>{{product.thumbsupnum}}</text>
								</view>
								<view :style='{"width":"20%","padding":"0 20rpx 0 0","display":"inline-block","order":"4"}'>
									...
									<text :style='{"color":"#37E8DC","lineHeight":"50rpx","fontSize":"24rpx"}'>{{product.storeupnum}}</text>
								</view>
								<view :style='{"width":"20%","padding":"0 20rpx 0 0","display":"inline-block","order":"5"}'>
									...
									<text :style='{"color":"#15D1E8","lineHeight":"50rpx","fontSize":"24rpx"}'>{{product.clicknum}}</text>
								</view>
							</view>
						</view>
					</view>
