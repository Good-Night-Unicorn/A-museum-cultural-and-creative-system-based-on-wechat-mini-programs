<template>
	<view :style='{"minHeight":"100%","padding":"20rpx","flexWrap":"wrap","background":"#DCF7FF","display":"flex","width":"100%","position":"relative","height":"auto"}'>
		...
		<swiper :style='{"width":"100%","background":"none","height":"360rpx"}' class="swiper" :indicator-dots='false' :autoplay='false' :circular='false' indicator-active-color='#000000' indicator-color='rgba(0, 0, 0, .3)' :duration='500' :interval='5000' :vertical='false'>
			<swiper-item :style='{"width":"100%","background":"none","height":"360rpx"}' v-for="(swiper,index) in swiperList" :key="index">
				<image :style='{"width":"100%","objectFit":"cover","borderRadius":"20rpx","display":"block","height":"360rpx"}' mode="aspectFill" v-if="swiper.substring(0,4)=='http'" :src="swiper" @tap="imgView2(swiper)"></image>
				<image :style='{"width":"100%","objectFit":"cover","borderRadius":"20rpx","display":"block","height":"360rpx"}' mode="aspectFill" v-else :src="baseUrl+swiper" @tap="imgView2(baseUrl+swiper)"></image>
			</swiper-item>
		</swiper>
		<view :style='{"margin":"20rpx 0 0","borderRadius":"20rpx 20rpx 0 0","textAlign":"center","background":"#fff","width":"100%","fontSize":"40rpx","fontWeight":"700","order":"1"}'>
			{{forum.title}}
		</view>
		<view :style='{"padding":"10rpx 0","margin":"0","color":"#888","textAlign":"center","background":"#fff","width":"100%","fontSize":"20rpx","fontWeight":"700","order":"2"}'>
			<span class="icon iconfont icon-touxiang18" :style='{"padding":"0","fontSize":"24rpx"}'></span>
			<span :style='{"padding":"0 10rpx","fontSize":"24rpx"}'>发布人：</span>
			<span :style='{"padding":"0","fontSize":"24rpx"}'>{{forum.userid!=userid&&forum.isanon==1?'匿名':forum.username}}</span>
		</view>
		<view class="operateView" :style='{"padding":"10rpx 0 0","overflow":"hidden","alignItems":"center","borderRadius":"0 0 20rpx 20rpx ","background":"#fff","display":"flex","width":"100%","justifyContent":"space-around","order":"4"}'>
			<view v-if="!likeType" :style='{"width":"50%","padding":"10rpx 20rpx","color":"#fff","textAlign":"center","background":"linear-gradient(225.00deg, rgb(55, 232, 220) 0%,rgb(28, 195, 238) 100%)"}' @click="likeClick">
			...
			<view v-if="!collectType" :style='{"width":"50%","padding":"10rpx 20rpx","color":"#999898","textAlign":"center","background":"#EDEDED"}' @click="collectClick">
				<span class="icon iconfont icon-shoucang10" :style='{"color":"inherit"}'></span>
				<span :style='{"color":"inherit"}'>收藏({{allCollect}})</span>
			</view>
			<view v-if="collectType" :style='{"width":"50%","padding":"10rpx 20rpx","color":"#999898","textAlign":"center","background":"#EDEDED"}' @click="collectClick">
				<span class="icon iconfont icon-shoucang10" :style='{"color":"inherit"}'></span>
				<span :style='{"color":"inherit"}'>取消收藏({{allCollect}})</span>
			</view>
		</view>
		<view :style='{"padding":"20rpx","margin":"0","background":"#fff","width":"100%","letterSpacing":"4rpx","fontSize":"30rpx","lineHeight":"52rpx","order":"3"}'>
			<rich-text :nodes="forum.content"></rich-text>
		</view>
		<view :style='{"width":"100%","margin":"20rpx 0 168rpx","order":"5"}'>
			<view :style='{"width":"100%","margin":"0 0 20rpx","borderRadius":"20rpx","background":"#fff"}' v-for="comment in commentData" :key="comment.id">
				...
				<view :style='{"color":"#333","padding":"0 20rpx 20rpx 100rpx","fontSize":"28rpx"}'>
					...
					<view :style='{"width":"100%","alignItems":"center","justifyContent":"flex-end","display":"flex"}'>
						<text @tap="onReplyTap(comment.id)" :style='{"color":"#37E8DC","padding":"0 12rpx"}'>回复</text>
						<text @tap="delClick(comment.id)" v-if="userid==comment.userid" :style='{"color":"#37E8DC"}'>删除</text>
					</view>
				</view>
				<view :style='{"width":"100%","padding":"0 0 0 120rpx"}' v-if="comment.childs">
					<view :style='{"width":"100%"}' v-for="item in comment.childs" :key="item.id">
						...
						<view :style='{"border":"2rpx solid #eee","padding":"0 20rpx 20rpx 100rpx","fontSize":"28rpx","color":"#333","borderWidth":"0 0 2rpx"}'>
							...
							<view :style='{"width":"100%","alignItems":"center","justifyContent":"flex-end","display":"flex"}'>
								<text :style='{"color":"#37E8DC"}' @tap="delClick(item.id)" v-if="userid==item.userid">删除</text>
							</view>
						</view>
					</view>
				</view>
