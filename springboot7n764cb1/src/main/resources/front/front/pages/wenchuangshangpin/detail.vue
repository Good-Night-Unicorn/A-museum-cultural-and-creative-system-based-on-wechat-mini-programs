	...
	<view class="content">
		<view class="container" :style='{"width":"100%","padding":"20rpx","position":"relative","background":"#DCF7FF","height":"auto"}'>
			...
			<view :style='{"width":"100%","padding":"0","background":"none","height":"auto"}' class="detail-content">
				<view :style='{"padding":"10rpx 20rpx","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}' class="detail-list-item price">
				...
				<view :style='{"borderColor":"#E8E8E8","background":"#fff","borderWidth":"0 0 2rpx","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="detail-list-item title">
					<view :style='{"width":"160rpx","padding":"0 20rpx 0 0","lineHeight":"80rpx","fontSize":"28rpx","color":"#333","textAlign":"right"}' class="lable">产品分类：</view>
					<view :style='{"padding":"0px","margin":"0px","lineHeight":"80rpx","fontSize":"28rpx","color":"rgb(0, 0, 0)"}' class="text" >{{detail.chanpinfenlei}}</view>
				</view>
				...
				<view class="detail-list-item" :style='{"borderColor":"#E8E8E8","background":"#fff","borderWidth":"0 0 2rpx","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"width":"160rpx","padding":"0 20rpx 0 0","lineHeight":"80rpx","fontSize":"28rpx","color":"#333","textAlign":"right"}'>产品编号：</view>
					<view class="text" :style='{"padding":"0px","margin":"0px","lineHeight":"80rpx","fontSize":"28rpx","color":"rgb(0, 0, 0)"}' >{{detail.chanpinbianhao}}</view>
				</view>
				<view class="detail-list-item" :style='{"borderColor":"#E8E8E8","background":"#fff","borderWidth":"0 0 2rpx","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
				...
				<view class="detail-list-item" :style='{"borderColor":"#E8E8E8","background":"#fff","borderWidth":"0 0 2rpx","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"width":"160rpx","padding":"0 20rpx 0 0","lineHeight":"80rpx","fontSize":"28rpx","color":"#333","textAlign":"right"}'>价格：</view>
					<view class="text" :style='{"padding":"0px","margin":"0px","lineHeight":"80rpx","fontSize":"28rpx","color":"rgb(0, 0, 0)"}' >{{detail.jiage}}</view>
				</view>
				<view class="detail-list-item" :style='{"borderColor":"#E8E8E8","background":"#fff","borderWidth":"0 0 2rpx","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"width":"160rpx","padding":"0 20rpx 0 0","lineHeight":"80rpx","fontSize":"28rpx","color":"#333","textAlign":"right"}'>积分：</view>
					<view class="text" :style='{"padding":"0px","margin":"0px","lineHeight":"80rpx","fontSize":"28rpx","color":"rgb(0, 0, 0)"}' >{{detail.jifen}}</view>
				</view>
				<view class="detail-list-item" :style='{"borderColor":"#E8E8E8","background":"#fff","borderWidth":"0 0 2rpx","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"width":"160rpx","padding":"0 20rpx 0 0","lineHeight":"80rpx","fontSize":"28rpx","color":"#333","textAlign":"right"}'>上架日期：</view>
					<view class="text" :style='{"padding":"0px","margin":"0px","lineHeight":"80rpx","fontSize":"28rpx","color":"rgb(0, 0, 0)"}' >{{detail.shangjiariqi}}</view>
				</view>
				<view class="detail-list-item" :style='{"borderColor":"#E8E8E8","background":"#fff","borderWidth":"0 0 2rpx","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
				...
				<view class="detail-list-item rich" :style='{"width":"100%","margin":"0","borderColor":"#ccc","background":"#fff","display":"flex","height":"auto"}'>
					<view class="lable" :style='{"padding":"0 20rpx 0 0","color":"#333","textAlign":"right","display":"none","width":"160rpx","lineHeight":"80rpx","fontSize":"28rpx"}'>民族文化：</view>
					<view class="rich-text" :style='{"padding":"24rpx","margin":"0"}'>
						<rich-text :nodes="detail.minzuwenhua"></rich-text>
					</view>
				</view>
				<view class="detail-list-item rich" :style='{"width":"100%","margin":"0","borderColor":"#ccc","background":"#fff","display":"flex","height":"auto"}'>
					<view class="lable" :style='{"padding":"0 20rpx 0 0","color":"#333","textAlign":"right","display":"none","width":"160rpx","lineHeight":"80rpx","fontSize":"28rpx"}'>产品介绍：</view>
					<view class="rich-text" :style='{"padding":"24rpx","margin":"0"}'>
						<rich-text :nodes="detail.chanpinjieshao"></rich-text>
					</view>
				</view>
				<view class="detail-list-item rich" :style='{"width":"100%","margin":"0","borderColor":"#ccc","background":"#fff","display":"flex","height":"auto"}'>
					<view class="lable" :style='{"padding":"0 20rpx 0 0","color":"#333","textAlign":"right","display":"none","width":"160rpx","lineHeight":"80rpx","fontSize":"28rpx"}'>传统故事：</view>
					<view class="rich-text" :style='{"padding":"24rpx","margin":"0"}'>
						<rich-text :nodes="detail.chuantonggushi"></rich-text>
					</view>
				</view>
				...
				<view class="bottom-content bg-white tabbar border shop" :style='{"width":"100%","padding":"0","flexWrap":"wrap","background":"none","display":"flex","height":"auto"}'>
					...
					<button :style='{"border":"0","padding":"0 20rpx","margin":"0 1% 10rpx","color":"rgb(255, 255, 255)","background":"#4EA0B8","width":"calc(100% / 3 - 2%)","fontSize":"28rpx","lineHeight":"80rpx","height":"80rpx"}' v-if="userid&&isAuth('wenchuangshangpin','立即购买')" @tap="onAcrossTap('goumaidingdan','','','','')" class="cu-btn bg-brown round shadow-blur" >立即购买</button>
					<button :style='{"border":"0","padding":"0 20rpx","margin":"0 1% 10rpx","color":"rgb(255, 255, 255)","background":"#4EA0B8","width":"calc(100% / 3 - 2%)","fontSize":"28rpx","lineHeight":"80rpx","height":"80rpx"}' v-if="!userid&&isAuthFront('wenchuangshangpin','立即购买')" @tap="onAcrossTap('goumaidingdan','','','','')" class="cu-btn bg-brown round shadow-blur" >立即购买</button>
					<button :style='{"border":"0","padding":"0 20rpx","margin":"0 1%","color":"rgb(255, 255, 255)","background":"#4EA0B8","width":"calc(100% / 3 - 2%)","fontSize":"28rpx","lineHeight":"80rpx","height":"80rpx"}' v-if="userid&&isAuth('wenchuangshangpin','私聊')" @tap="chatClick">联系TA</button>
					<button :style='{"border":"0","padding":"0 20rpx","margin":"0 1%","color":"rgb(255, 255, 255)","background":"#4EA0B8","width":"calc(100% / 3 - 2%)","fontSize":"28rpx","lineHeight":"80rpx","height":"80rpx"}' v-if="!userid&&isAuthFront('wenchuangshangpin','私聊')" @tap="chatClick">联系TA</button>
...
<script>
	export default {
		...
		async onShow(options) {
			...
			this.getStoreup();
			this.getThumbsup();
			let cleanType = uni.getStorageSync('discusswenchuangshangpinCleanType')
			if(cleanType){
				uni.removeStorageSync('discusswenchuangshangpinCleanType')
				this.mescroll.num = 1
			...
			if(crossCleanType) {
				...
				res = await this.$api.info('wenchuangshangpin', this.id);
				let reg=new RegExp('http://localhost:8080/springboot7n764cb1/upload','g')//g代表全部
				if(res.data.minzuwenhua){
					res.data.minzuwenhua = res.data.minzuwenhua.replace(reg, this.$base.url + 'upload');
				}
				if(res.data.chanpinjieshao){
					res.data.chanpinjieshao = res.data.chanpinjieshao.replace(reg, this.$base.url + 'upload');
				}
				if(res.data.chuantonggushi){
					res.data.chuantonggushi = res.data.chuantonggushi.replace(reg, this.$base.url + 'upload');
				}
		...
		methods: {
			...
			onPayTap(){
				...
				uni.setStorageSync('paytable','wenchuangshangpin');
					...
					uni.showModal({
						...
						success: async function(res) {
							if (res.confirm) {
								...
								await _this.$api.update('wenchuangshangpin',_this.detail)
			...
			async onAcrossTap(tableName,crossOptAudit,crossOptPay,statusColumnName,tips,statusColumnValue,type=1){
				...
				uni.setStorageSync('crossTable','wenchuangshangpin');
			...
			async init(type=1){
				...
				let res = await this.$api.info('wenchuangshangpin', this.id);
				let reg=new RegExp('http://localhost:8080/springboot7n764cb1/upload','g')//g代表全部
				res.data.minzuwenhua = res.data.minzuwenhua.replace(reg, this.$base.url + 'upload');
				res.data.chanpinjieshao = res.data.chanpinjieshao.replace(reg, this.$base.url + 'upload');
				res.data.chuantonggushi = res.data.chuantonggushi.replace(reg, this.$base.url + 'upload');
				...
				//修改富文本的图片样式
				this.detail.minzuwenhua = this.detail.minzuwenhua.replace(/img src/gi,"img style=\"width:100%;\" src");

				//修改富文本的图片样式
				this.detail.chanpinjieshao = this.detail.chanpinjieshao.replace(/img src/gi,"img style=\"width:100%;\" src");

				//修改富文本的图片样式
				this.detail.chuantonggushi = this.detail.chuantonggushi.replace(/img src/gi,"img style=\"width:100%;\" src");
				...
				if(type==2){
					...
					await this.$api.update('wenchuangshangpin',this.detail)
				}
			},
			...
			async upCallback(mescroll) {
				if(uni.getStorageSync("appUserid")){
					let res = await this.$api.list('discusswenchuangshangpin', {
						page: mescroll.num,
						limit: 10,
			...
			async comzanClick(row){
				...
				if(!this.comzanChange(row)){
					...
					await this.$api.update('discusswenchuangshangpin',row)
					this.$utils.msg('点赞成功');
				}else {
					row.thumbsupnum--
					let arr = String(row.tuserids).split(',')
			...
			async onCommentTap() {
				...
				let res = {}
				this.$utils.jump(`../discusswenchuangshangpin/add-or-update?refid=${this.id}` )
			},
			delClick(id){
				let that = this
				uni.showModal({
					...
					async success(res) {
						if(res.confirm){
							await that.$api.del('discusswenchuangshangpin',JSON.stringify([id]))
							that.$utils.msg('删除成功')
							that.detail.discussnum--
							await that.$api.update('wenchuangshangpin',that.detail)
							setTimeout(()=>{
