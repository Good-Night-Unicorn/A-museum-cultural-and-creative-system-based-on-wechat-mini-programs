<template>
	<mescroll-uni @init="mescrollInit" :up="upOption" :down="downOption" @down="downCallback" @up="upCallback">
		...
		<view :style='{"minHeight":"100%","width":"100%","padding":"0","position":"relative","background":"#DCF7FF","height":"auto"}'>
			<!--header end-->
			<view class="cu-bar bg-white search" :style='{"width":"100%","padding":"20rpx","background":"none","display":"flex","height":"auto"}'>
				<view class="search-form round" :style='{"margin":"0 12rpx 0 0","flex":"1","position":"relative"}'>
					...
					<input :style='{"border":"2rpx solid rgb(55, 232, 220)","padding":"12rpx 20rpx 12rpx 80rpx","color":"#333","borderRadius":"10rpx","background":"#fff","width":"100%","lineHeight":"56rpx","fontSize":"28rpx","height":"80rpx"}' v-model="searchForm.title" type="text" placeholder="标题" ></input>
				</view>
			...
			<view class="list" :style='{"padding":"20rpx"}'>
				<view :style='{"color":"#000","margin":"0 0 16rpx"}'>
					交流论坛专区
				</view>
